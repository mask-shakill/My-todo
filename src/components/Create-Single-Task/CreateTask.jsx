...
const CreateTask = () => {
  ...
  const handleSubmit = (e) => {
    ...
    const exData = JSON.parse(localStorage.getItem("taskData")) || [];
    const updateData = [...exData, newTask];
  ...
  return (
    <div className="mt-10">
      ...
      <section className="flex flex-col  items-center md:flex-col md:items-center">
        <h1 className="text-3xl font-semibold mt-10 mb-3">Create task</h1>
        <form className="flex flex-col gap-y-3 bg-gray-300 w-[100%] md:w-[60%] items-center py-10 rounded-lg">
          <input
            ...
            className="md:w-1/2 h-14 rounded-md p-2 text-lg"
          ...
          <select
            ...
            onChange={handleChange}
            className="w-[85%] md:w-1/2 h-14 rounded-md p-2"
          >
          ...
          <input
            className="w-[85%] md:w-1/2 rounded h-14 p-2"
            type="date"
            name="deadline"
            onChange={handleChange}
